...
import static com.darkyen.retinazer.Components.FULL_SET;
...
public class EngineTest {
	...
	public static class ExampleSystem implements EngineService {
		...
		public @Wire
		Mapper<Components.FlagComponentA> mFlagA;
		public @Wire
		Mapper<Components.FlagComponentB> mFlagB;
		public @Wire
		Mapper<Components.FlagComponentC> mFlagC;

		public @Wire
		List<EntityProcessorSystem> processorSystemsList;
	}
