...
import com.darkyen.retinazer.systems.FamilyWatcherSystem;
...
public class EntityListenerTest {
	...
	public void testFamilyListener() {
		EntityListenerMock listenerB = new EntityListenerMock(Components.FULL_SET.familyWith(Components.FlagComponentB.class)) {
		};
		EntityListenerMock listenerC = new EntityListenerMock(Components.FULL_SET.familyWith(Components.FlagComponentC.class)) {
		};
		Engine engine = new Engine(Components.FULL_SET, listenerB, listenerC);
